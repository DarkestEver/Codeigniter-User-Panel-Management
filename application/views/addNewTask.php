                        ...
                        <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control required" id="priority" name="priority">
                                            ...
                                            if(!empty($tasks_prioritys))
                                            {
                                                ...
                                                {
                                                    ?>
                                                    <option value="<?php echo $rl->priorityId ?>" <?php if($rl->priorityId == set_value('priority')) {echo "selected=selected";} ?>><?php echo $rl->priority ?></option>
                                                    <?php
                                                }
                                            }
                                            ?>
                            ...
                            <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="comment" name="comment" rows="4"><?php echo set_value('comment'); ?></textarea>
                                    </div>
                                </div>
