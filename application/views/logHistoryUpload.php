        ...
        <div class="row">
            <div class="col-xs-12">
              <div class="box">
                ...
                <?php } ?>
                <form role="form" action="<?php echo base_url() ?>logHistoryUploadFile" method="post" id="LoghistoryUpload" role="form" enctype="multipart/form-data" accept-charset="utf-8">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6">
                  ...
                  <p class="help-block">Yedek yükleme için sunucudan veya dosya seç üzerinden yedek seçmeniz gerekir.</p>
                </div>
                                    </div>
                                </div>    
                            </div>
