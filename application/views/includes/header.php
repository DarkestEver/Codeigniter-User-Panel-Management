    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="<?php echo base_url(); ?>" class="logo">
          ...
          <span class="logo-mini"><b>BSE</b>U</span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b>BSEU</b>YONETIM</span>
        </a>
            ...
            <ul class="nav navbar-nav">
              <li class="dropdown tasks-menu">
                ...
                <ul class="dropdown-menu">
                  <li class="header"> Son Giriş : <i class="fa fa-clock-o"></i> <?= empty($last_login) ? "First Time Login" : $last_login; ?></li>
                </ul>
              </li>
              ...
              <li class="dropdown user user-menu">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-footer">
                    <div class="pull-left">
                      <a href="<?php echo base_url(); ?>loadChangePass" class="btn btn-default btn-flat"><i class="fa fa-key"></i> Şifre Değiştir</a>
                    </div>
                    <div class="pull-right">
                      <a href="<?php echo base_url(); ?>logout" class="btn btn-default btn-flat"><i class="fa fa-sign-out"></i> Çıkış Yap</a>
                    </div>
                  </li>
                </ul>
              </li>
